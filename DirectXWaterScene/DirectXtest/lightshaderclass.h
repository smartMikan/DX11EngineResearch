...
public:
	...
	void Shutdown();
	bool Render(ID3D11DeviceContext*, int, ID3D11ShaderResourceView * texture, MatrixBufferType, CameraBufferType, LightBufferType);
	...
	LightBufferType GenerateLightBuffer(XMFLOAT4 ambientColor, XMFLOAT4 diffuseColor, XMFLOAT3 lightDirection);
...
private:
	...
	bool SetShaderParameters(ID3D11DeviceContext* deviceContext, MatrixBufferType wvpMatrixBuffer, ID3D11ShaderResourceView* texture, CameraBufferType cameraBuffer, LightBufferType lightBuffer);
