...
bool FontShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"./Shader/FontVertexShader.hlsl", L"./Shader/FontPixelShader.hlsl");
	if (!result)
	{
		return false;
	}
...
bool FontShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, const WCHAR * vertexshaderfilename, const WCHAR * pixelshaderfilename)
{
	HRESULT result;
	...
	result = D3DCompileFromFile(vertexshaderfilename, NULL, NULL, "FontVertexShader", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
	...
	if (FAILED(result))
	{
		...
		{
			MessageBoxW(hwnd, vertexshaderfilename, L"Missing Shader File", MB_OK);
		}
	...
	// Compile the vertex shader code.
	result = D3DCompileFromFile(pixelshaderfilename, NULL, NULL, "FontPixelShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
	...
	if (FAILED(result))
	{
		...
		{
			MessageBoxW(hwnd, pixelshaderfilename, L"Missing Shader File", MB_OK);
		}
