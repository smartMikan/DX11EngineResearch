...
namespace
{
    ...
    DXGI_FORMAT GetDXGIFormat(const DDS_PIXELFORMAT& ddpf)
    {
        if (ddpf.flags & DDS_RGB)
        {
            ...
            {
            case 32:
                if (ISBITMASK(0x000000ff, 0x0000ff00, 0x00ff0000, 0xff000000) || ISBITMASK(0x000000ff, 0x0000ff00, 0x00ff0000, 0x00000000))
                {
                ...
                // No DXGI format maps to ISBITMASK(0x000000ff,0x0000ff00,0x00ff0000,0x00000000) Also Known As D3DFMT_X8B8G8R8
