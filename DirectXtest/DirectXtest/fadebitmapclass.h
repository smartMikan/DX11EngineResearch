...
public:
	...
	bool Initialize(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int screenWidth, int screenHeight, int bitmapWidth, int bitmapHeight);
	void Shutdown();
...
private:
	...
	//The FadeBitmapClass will need to maintain some extra information that a 3D model wouldn't 
