...
FadeBitmapClass::FadeBitmapClass(const FadeBitmapClass&)
{
}
...
bool FadeBitmapClass::Initialize(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int screenWidth, int screenHeight, int bitmapWidth, int bitmapHeight)
{
	bool result;
...
//ID3D11ShaderResourceView* FadeBitmapClass::GetTexture()
//{
...
bool FadeBitmapClass::LoadTexture(ID3D11Device* device, ID3D11DeviceContext* deviceContext, const WCHAR * filename)
{
	bool result;
...
void FadeBitmapClass::ReleaseTexture()
{
